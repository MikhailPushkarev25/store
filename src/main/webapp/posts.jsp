    ...
    <div class="card" style="width: 100%">
        ...
        <div class="card-body">
            <table class="table">
                <thead>
                <tr>
                    <th scope="col">Названия заказов</th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${posts}" var="post">
                    <tr>
                        ...
                        <td><a href="<c:url value='/buy'/>">Купить</a></td>

                        <td>
                            <img src="<c:url value='/download?id=${post.id}'/>" width="100px" height="100px"/>
                        </td>
                        <td>
                            <a href="<c:url value='/upload?id=${post.id}'/>">
